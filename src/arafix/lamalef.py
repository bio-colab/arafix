...
#: كلمة عربية: من همزة القطع حتى صدر القرآن (U+06D3) — يشمل الألف الوصلية
#: (ٱ U+0671)، والألف الخنجرية (ٰ U+0670)، والحركات، والتطويل. كان النطاق
#: أضيق (0621–064A) فتقطّعت الكلمات عند هذه المحارف وفشل إصلاح المعجم
#: بصمت مع رسمٍ قرآنيّ مثل «ٱلمجالت» رغم شهادة المستند نفسه.
_WORD = re.compile(r"[\u0621-\u06D3]+")
