...
|---|---|---|---|
| **P0** | **سد فجوة خطأ الكلمات (WER Gap Recovery)** | حالياً: Letters-CER = 0.82% لكن WER = 17.21% بسبب حدود المسافات بين الكلمات عند الحروف غير المتصلة. المستهدف: WER < 5%. | نشط — المرحلة القادمة |
| **P1** | **كشف التخطيط المعقد متعدد الأعمدة** | معالجة النصوص متعددة الأعمدة RTL دون تداخل السطور أو ارتباك قراءة الهوامش. | مجدول |
